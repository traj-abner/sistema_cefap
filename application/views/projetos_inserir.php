...
?>
 <div id="breadcrumbs"><?php    echo set_breadcrumb(); ?> </div> 
    <div class="well"><h2>Criar Projeto</h2>
	...
	<table>
    	...
    	<table style="width:100%;">
            ...
            <tr>
                ...
                <td class="left"><input type="text" name="instituicao" maxlength="250" style="width:370px;"  /></td>
            </tr>
            <tr>
                ...
                <td class="left"><input type="text" name="telefone2" maxlength="30" style="width:370px;"  /></td>
            </tr>
             <tr>
