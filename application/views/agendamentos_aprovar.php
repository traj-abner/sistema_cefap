    	...
    	<table>
            ...
            <tr>
             ...
             <tr>
                ...
                <td class="left"><input type="radio" name="pagto" <?php if ($ag->status_pagto == STATUS_PAGTO_NAO_PAGO) echo 'checked="checked"'; ?> value="keep" />Pendente</td>
                <td class="left" colspan="2"><input type="radio" <?php if ($ag->status_pagto == STATUS_PAGTO_PAGO) echo 'checked="checked"'; ?> name="pagto" value="change" />Pago</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="left" colspan="2"><input type="radio" name="how" checked="checked" value="keep" />Manter Data Requisitada</td>
                <td class="left" colspan="2"><input type="radio" name="how" value="change" />Usar data Selecionada</td>
            </tr>
        </table>
